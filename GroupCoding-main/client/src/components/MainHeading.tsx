        ...
        <>
            <div className="fixed w-full h-[60px] bg-black border-b border-borders flex felx-row z-[100]">
                <Link to="/" className=" select-none">
                    ...
                    >
                        <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-pink-600 px-[1px]">
                            GC: Group
                        </span>
                        <span>Coding</span>
                    </div>
                ...
                {data?.status === "loggedin" || data?.status == undefined ? (
                    ...
                    <div className="fixed flex flex-row right-[36px] items-center h-[60px]">
                        ...
                        <Link
                            to="/signup"
                            className="ml-[8px] font-bold inline-block py-[6px] px-[16px] bg-gradient-to-r from-blue-500 to-purple-600 border rounded-md border-borders text-black text-[14px] hover:bg-red-800"
                        >
                            Sign Up
                        </Link>
                    </div>
